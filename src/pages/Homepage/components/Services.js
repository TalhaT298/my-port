...
const Services = () => {
    const services = [
        ...
        },
        {
            ...
            "details": "Along with the Frontend I am skilled in Node JS, Express, JWT and Firebase. Proficient in implementing Mongo DB database. More than 6 months of experience with Full Stack development. I love coding the most and learning and researching new technologies"
        },
    ]
    return (
        <>
